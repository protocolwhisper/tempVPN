...
require_entitlement_value "$app_entitlements" "com.apple.developer.networking.networkextension.0" "packet-tunnel-provider"
require_entitlement_value "$extension_entitlements" "com.apple.developer.networking.networkextension.0" "packet-tunnel-provider"
