...
Define the durable coordinator contracts that preserve fixed paid entitlements, prevent duplicate payment redemption, and authorize node generations without exposing client secrets.
