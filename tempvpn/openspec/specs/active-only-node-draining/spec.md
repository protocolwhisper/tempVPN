# Active-Only Node Draining Specification

## Purpose

Define blue/green generation admission, active-session pinning, peer handoff,
and the observable safety gates required before an old node generation can be removed.
